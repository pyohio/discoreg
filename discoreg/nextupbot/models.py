...
class SessionNotification(models.Model):
    ...
    field_1_value = models.CharField(max_length=1024, null=True, blank=True, default=None)
    field_2_name = models.CharField(max_length=256, null=True, blank=True, default=None)
    field_2_value = models.CharField(max_length=1024, null=True, blank=True, default=None)
    field_3_name = models.CharField(max_length=256, null=True, blank=True, default=None)
    field_3_value = models.CharField(max_length=1024, null=True, blank=True, default=None)
    author_name = models.CharField(max_length=256, default="Up next:", null=True, blank=True)
